...
from users.views import ChangeEmailView, IsRegistrationDisabled, PublicUserProfileView
...
urlpatterns = [
    ...
    path('auth/users/', PublicUserProfileView.as_view(), name='public_profiles'),
#     make a route /auth/users/<uuid> that returns the user's profile
    path('auth/users/<str:pk>', PublicUserProfileView.as_view(), name='user_profile'),
